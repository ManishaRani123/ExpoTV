					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="sec-heading center">
								<h3>FEATURED <span class="theme-cl"> Exhibitors
</span></h3>
							</div>
						</div>
					</div>
							...
							<div class="Reveal-grid-item classical-list">
								...
								<div class="Reveal-listing-footer-info">
									<div class="listing-cat">
										<a href="listing.php?name=<?php echo $featuredExhibitor['slug']; ?>" class="cat-icon cl-1"><i class="lni-world cbg-1"></i><?php echo $featuredExhibitor['website']; ?></a>
									</div>
									<div class="m-listing-status">
										<a href="listing.php?name=<?php echo $featuredExhibitor['slug']; ?>"> <span class="l-status l-open">Open</span> </a>
									</div>
								</div>
