                               ...
                               <div class="text-center mb-4"><img src="assets/img/logo.png" class="img-fluid" alt="" /></div>
								<div class="row main_login_form">
									<div class="login_form_dm">
										<form action="login-check.php" id="member_login" method="POST" class="edd_form">
											<fieldset>
												<p class="edd-login-username">
													<label>Email</label>
													<input class="form-control" type="email" id="email" name="email" placeholder="Your Username or Email">
												</p>
