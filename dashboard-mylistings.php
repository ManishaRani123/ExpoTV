...
<head>
		...
		<title>My Listings - ExpoTV Online</title>
		<!-- All Plugins Css -->
									...
									<ul>
										...
										<li>
											...
											<div class="buttons-to-right">
												<a href="dashboard-photo.php?name=<?php echo $listing['slug']; ?>" class="button gray"><i class="ti-pencil"></i> Edit</a>
												<a href="listing.php?name=<?php echo $listing['slug']; ?>" class="button gray"><i class="ti-trash"></i> View</a>
											</div>
										</li>
										<?php
										} ?>
