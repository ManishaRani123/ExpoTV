...
if(isset($_POST['imageProfilePicture']))
{
	...
	$image_name_profilePicture = time() . '.png';
	$image_location_profilePicture = 'upload/' . $image_name_profilePicture;
	$username = $_SESSION["email"];

	file_put_contents($image_location_profilePicture, $data_profilePicture);

	mysqli_query($mysqli, "UPDATE users SET profile_photo='$image_name_profilePicture' WHERE email='$username'");
...
if(isset($_POST['imageProfileLogo']))
{
	...
	$image_location_profileLogo = 'upload/' . $image_name_profileLogo;
	$username = $_SESSION["email"];

	file_put_contents($image_location_profileLogo, $data_profileLogo);

	mysqli_query($mysqli, "UPDATE users SET profile_logo='$image_name_profileLogo' WHERE email='$username'");
...
if(isset($_POST['image']))
{
	...
	mysqli_query($mysqli, "UPDATE users SET profile_coverImg='$image_name' WHERE email='$username'");
